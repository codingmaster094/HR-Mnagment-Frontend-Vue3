...
const toggledeleteMode = (id) => {
    DeleteUserprofile_Others(id)
    get_Others()
}
const updatedependant = (id) => {
    UpdateUserprofile_Others(
        id, 
      UserDataprofile_Others.value.Custom_document = UserDataprofile_Others.value.Custom_document,
      UserDataprofile_Others.value.Attachments = formdata.Attachments,
     )
...
<template>
    <div>
        <div v-if="UserDataprofile_Others.value !== null" class="emp-from-wrapper imp-dates">
                        ...
                        <div>
                            <div v-if="EditShow == false" class="grid grid-cols-1 md:grid-cols-2">
                                <div class="md:col-span-1">
                                    <div class="text-left">
                                        <div v-for="(contactData, index) in UserDataprofile_Others"
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 ml-3">
            <div class="text-left">
    ...
    <div v-if="showModal"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" @submit.prevent="updatedependant(UserDataprofile_Others._id)">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Type product name" v-model="UserDataprofile_Others.Custom_document" required="">
                        </div>
                        <div class="col-span-2">
                            <label for="name"
